    ...
    >
      ...
      <template slot="action" slot-scope="text,record">
        <div class="action_class">
          <div class="build" @click="createStudentProfile(record)">建档</div>
        </div>
      </template>
    </a-table>
    <add-student ref="form"></add-student>
  </a-card>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      createStudentProfile(order) {
        const that = this.$refs.form;
        that.visible = true;
        that.form = {
          name : order.studentName,
          guardianName: order.patriarchName,
          guardianPhone: order.tel
        };
      },
